...
Description: adds a "jump to content" hidden bar at the top of the site, it is activated with "tab" button. and helps disabled surfers to navigate the site.
Version: 0.2
...
<div id='skip' style='margin: 0;height: 1px;' >
	<ul>
						 <li><a onfocus="document.getElementById('skip').style.height='16px';this.className = 'visible-link'" onblur="document.getElementById('skip').style.height='1px';this.className = 'hidden-link'" href='#' class='hidden-link' tabindex="1">דלג לתוכן רצוי</a></li>
			 <li><a tabindex=1 onfocus="document.getElementById('skip').style.height='16px';this.className = 'visible-link'" onblur="document.getElementById('skip').style.height='1px';this.className = 'hidden-link'" href='<?php echo get_option('jump1'); ?>' class='hidden-link' tabindex="1"><?php echo get_option('jump11'); ?></a></li>
			 <li><a tabindex=2 onfocus="document.getElementById('skip').style.height='16px';this.className = 'visible-link'" onblur="document.getElementById('skip').style.height='1px';this.className = 'hidden-link'" href='<?php echo get_option('jump2'); ?>' class='hidden-link' ><?php echo get_option('jump22'); ?></a></li>
			 <li><a tabindex=3 onfocus="document.getElementById('skip').style.height='16px';this.className = 'visible-link'" onblur="document.getElementById('skip').style.height='1px';this.className = 'hidden-link'" href='<?php echo get_option('jump3'); ?>' class='hidden-link' ><?php echo get_option('jump33'); ?></a></li>
			 <li><a tabindex=4 onfocus="document.getElementById('skip').style.height='16px';this.className = 'visible-link'" onblur="document.getElementById('skip').style.height='1px';this.className = 'hidden-link'" href='<?php echo get_option('jump4'); ?>'  class='hidden-link' ><?php echo get_option('jump44'); ?></a></li>
			 <li><a tabindex=5 onfocus="document.getElementById('skip').style.height='16px';this.className = 'visible-link'" onblur="document.getElementById('skip').style.height='1px';this.className = 'hidden-link'" href='<?php echo get_option('jump5'); ?>' class='hidden-link' ><?php echo get_option('jump55'); ?></a></li>
			 <li><a tabindex=6 onfocus="document.getElementById('skip').style.height='16px';this.className = 'visible-link'" onblur="document.getElementById('skip').style.height='1px';this.className = 'hidden-link'" href='<?php echo get_option('jump6'); ?>' class='hidden-link' ><?php echo get_option('jump66'); ?></a></li>
	</ul>
</div>
